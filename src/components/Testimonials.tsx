...
const testimonials = [
  ...
  { name: 'Sofia P.',     location: 'Dartmouth, NS',             service: 'Direct Billing',     rating: 5, text: 'Direct billing made everything so easy. I didn\'t have to worry about money at all — they handled everything with my insurance. The booking reminder text was super helpful too.' },
  { name: 'Marcus T.',    location: 'Cole Harbour, NS',          service: 'Referral Reward',    rating: 5, text: 'I referred my three coworkers and got a $50 credit — and they all love it too! The online intake form saved so much time in the waiting room. Very modern and professional.' },
