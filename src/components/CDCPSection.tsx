...
export default function CDCPSection() {
  ...
  return (
    <section id="cdcp" className="relative py-28 px-6 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-primary-600/10 blur-[120px] pointer-events-none animate-blob" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-cyan-500/7 blur-[80px] pointer-events-none animate-blob-alt" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-white/10 border border-white/15 text-white/80 text-[11px] font-bold uppercase tracking-widest px-4 py-2 rounded-full mb-7"
            >
            ...
            <motion.p
              ...
              className="text-sky-300/80 text-[15px] leading-relaxed mb-10"
            >
            ...
            <div className="space-y-4 mb-10">
              {tiers.map((tier, i) => (
                <motion.div
                  ...
                  whileHover={{ x: 4 }}
                  className="glass-dark rounded-2xl p-5 border border-white/10 group cursor-default"
                >
          ...
          <motion.div
            ...
            className="glass-dark rounded-3xl p-8 border border-white/12"
          >
            ...
            <div className="space-y-5">
              {benefits.map((b, i) => (
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-primary-500/20 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-primary-500/35 transition-colors">
                    <CheckCircle2 size={16} className="text-accent" />
                  </div>
                  <div>
                    <div className="text-white font-semibold text-[13px] mb-1">{b.title}</div>
                    <div className="text-sky-300/70 text-[12px] leading-relaxed">{b.desc}</div>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            {/* Phone CTA */}
            <div className="mt-8 bg-white/8 border border-white/12 rounded-2xl px-5 py-4">
              <div className="flex items-center gap-2 text-sky-400/70 text-[11px] font-semibold mb-2">
                <Phone size={11} />
                Call to check your coverage
              </div>
              <a href="tel:9024354848" className="text-white text-2xl font-extrabold hover:text-accent transition-colors">
                902-435-4848
              </a>
